...
\usetheme{nwcler}
% if you want add a second logo in the title page and as logo at the footpage of each slide put the path and the name file as follow
\secondlogo{path/image.png}

% add second logo in the title page and at footlines of other slides
% \renewcommand{\secondlogo}{images/sapienzalogo.pdf}
